...
<form id="citationForm" action="insert_citation.php" method="POST">
  ...
  <script>
    ...
    // Validate at least one vehicle type is selected
    ...
    const violationCheckboxes = document.querySelectorAll('input[name="noHelmetDriver"], input[name="noHelmetBackrider"], input[name="noLicense"], input[name="expiredReg"], input[name="defectiveAccessories"], input[name="loudMuffler"], input[name="recklessDriving"], input[name="dragRacing"], input[name="disregardingSigns"], input[name="illegalParking"], input[name="otherViolation"]');
